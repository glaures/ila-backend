package sandbox27.ila.tools.special_2526_1.six_grade_physics;
...
public class SixGradePhysicsImporter {
    ...
    public List<Assignment> importFromFile() throws IOException {
        ...
        InputStream inputStream = new ClassPathResource("six_grade_physics.json").getInputStream();
